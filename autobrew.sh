...
main() {
    ...
    term_list="neovim tmux git gh awscli vercel-cli pnpm yarn nvm stow watchman starship fzf eza bat ripgrep zsh-autosuggestions zoxide opencode gemini-cli gcc make fd luarocks wget go markdownlint-cli2 eslint_d prettierd"
